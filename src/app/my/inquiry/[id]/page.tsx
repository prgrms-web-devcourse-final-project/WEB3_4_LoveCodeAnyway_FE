        ...
        */
        ...
        const mockInquiryDetails: Record<string, InquiryDetail> = {
          "1": {
            ...
            content:
              "회원가입 화면에서 정보를 모두 입력했는데도 가입 버튼이 활성화되지 않습니다. 어떻게 해야 하나요?",
            ...
            answer: {
              content:
                "안녕하세요, 고객님. 회원가입 화면에서 모든 필수 항목을 입력했는지 확인해주세요. 특히 이용약관과 개인정보 처리방침 동의 여부를 체크하지 않으면 가입 버튼이 활성화되지 않습니다. 다시 한번 시도해보시고, 문제가 지속되면 추가적인 스크린샷이나 정보와 함께 문의해주시면 더 자세히 도와드리겠습니다.",
          ...
          "2": {
            ...
            title: "페이지 로딩이 느려요",
            content:
              "최근 사이트 접속 시 페이지 로딩이 매우 느려졌습니다. 특히 메인 페이지와 마이페이지에서 로딩 시간이 오래 걸립니다. 브라우저는 크롬 최신 버전 사용 중이고, 인터넷 연결에는 문제가 없습니다.",
          ...
          "3": {
            ...
            content:
              "서울 강남구에 새로 오픈한 '미스터리룸' 테마를 등록 요청드립니다. 웹사이트 주소는 www.mysteryroom.com 입니다. 4개의 테마가 있고 모두 난이도와 장르가 다릅니다.",
            ...
            answer: {
              content:
                "안녕하세요, 등록 요청 감사합니다. 해당 테마룸 정보를 확인하여 빠른 시일 내에 등록 완료하겠습니다. 등록이 완료되면 별도로 알림 드리겠습니다.",
          ...
          "4": {
            ...
            content:
              "로그인 후 비밀번호를 변경하는 방법을 알려주세요. 마이페이지에서 찾아봤는데 관련 메뉴를 찾을 수 없었습니다.",
          ...
          "5": {
            ...
            content:
              "모바일로 접속하면 테마 목록 페이지에서 계속 에러가 발생합니다. 화면이 깨지고 스크롤이 되지 않습니다. 아이폰 13, iOS 16.5 환경입니다.",
            ...
            answer: {
              content:
                "안녕하세요, 문의주신 모바일 환경 오류 관련하여 확인해보았습니다. 현재 해당 이슈를 인지하고 있으며, 긴급 패치를 준비 중입니다. 6월 10일까지 해결될 예정이니 잠시만 기다려 주시면 감사하겠습니다.",
