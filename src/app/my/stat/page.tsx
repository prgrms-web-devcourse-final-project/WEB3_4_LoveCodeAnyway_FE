      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto p-6">
          <div className="bg-white p-8 rounded-xl shadow-sm text-center">
            <h1 className="text-2xl font-bold mb-4">통계를 불러올 수 없습니다</h1>
            <p className="text-gray-500 mb-6">탈출일지를 작성하시면 통계가 생성됩니다.</p>
            <button 
    ...
    <div className="bg-gray-50 min-h-screen pb-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <div>
                ...
                <h2 className="text-3xl font-bold">{statData.totalEscapeCount}</h2>
              </div>
              <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                <Image src="/images/count-icon.svg" alt="방 아이콘" width={24} height={24} className="opacity-60" />
              </div>
            </div>
            <p className="text-sm text-gray-500">탈출 성공률 <span className="text-[#4ecdc4] font-semibold">{statData.successRate}%</span></p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <div>
                ...
                <h2 className="text-3xl font-bold">{statData.noHintEscapeCount}</h2>
              </div>
              <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                <Image src="/images/star-icon.svg" alt="별 아이콘" width={24} height={24} className="opacity-60" />
              </div>
            </div>
            <p className="text-sm text-gray-500">노힌트 성공률 <span className="text-[#4ecdc4] font-semibold">28.5%</span></p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                <Image src="/images/hint-icon.svg" alt="전구 아이콘" width={24} height={24} className="opacity-60" />
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <h3 className="text-lg font-semibold mb-6">장르별 성공/실패 비율</h3>
            <p className="text-xs text-gray-500 mb-4">참여 비율 상위 5개 장르만 표시합니다.</p>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="relative h-64">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <RadarChart cx="50%" cy="50%" outerRadius="70%" data={statData.radarData}>
                  ...
                  <Radar name="사용자" dataKey="A" stroke="#8884d8" fill="#8884d8" fillOpacity={0.6} />
                  <Tooltip formatter={(value) => [`${value}`, '']} />
                </RadarChart>
              </ResponsiveContainer>
            </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <h3 className="text-lg font-semibold mb-6">월별 방탈출 장소 수와 평균 용맹 지수</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm text-center">
            ...
            <p className="text-xl font-semibold text-[#FF8B30]">{statData.lastEscapeDate}</p>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
            <div className="text-center">
              <div className="mb-2">
                <Image src="/images/count-icon.svg" alt="참여 테마 수" width={36} height={36} className="mx-auto" />
              </div>
              <p className="text-gray-500 text-xs">참여 테마 수</p>
              <p className="text-lg font-semibold">{statData.recentEscapes.count}개</p>
            </div>
            
            <div className="text-center">
              <div className="mb-2">
                <Image src="/images/star-icon.svg" alt="평균 만족도" width={36} height={36} className="mx-auto" />
              </div>
              <p className="text-gray-500 text-xs">평균 만족도</p>
              <p className="text-lg font-semibold">{statData.recentEscapes.avgRating}/5.0</p>
            </div>
            
            <div className="text-center">
              <div className="mb-2">
                <Image src="/images/bulb-icon.svg" alt="평균 힌트 사용" width={36} height={36} className="mx-auto" />
              </div>
              <p className="text-gray-500 text-xs">평균 힌트 사용</p>
              <p className="text-lg font-semibold">{statData.recentEscapes.avgHint}개</p>
            </div>
            
            <div className="text-center">
              <div className="mb-2">
                <Image src="/images/check-icon.svg" alt="탈출 성공률" width={36} height={36} className="mx-auto" />
              </div>
              <p className="text-gray-500 text-xs">탈출 성공률</p>
              <p className="text-lg font-semibold">{statData.recentEscapes.successRate}%</p>
            </div>
            
            <div className="text-center">
              <div className="mb-2">
                <Image src="/images/clock-icon.svg" alt="평균 소요 시간" width={36} height={36} className="mx-auto" />
              </div>
              <p className="text-gray-500 text-xs">평균 소요 시간</p>
              <p className="text-lg font-semibold">{statData.recentEscapes.avgTime}분</p>
            </div>
            
            <div className="text-center">
              <div className="mb-2">
                <Image src="/images/trophy-icon.svg" alt="최고 전적 대비" width={36} height={36} className="mx-auto" />
              </div>
              <p className="text-gray-500 text-xs">최고 전적 대비</p>
              <p className="text-lg font-semibold text-[#4ecdc4]">{statData.recentEscapes.bestResult}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <h3 className="text-lg font-semibold mb-6">난이도별 힌트 사용 패턴</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart
            ...
            <p className="text-xs text-gray-500 mt-2">난이도가 높을수록 힌트 사용량이 증가하는 경향이 있습니다.</p>
          </div>
          
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <h3 className="text-lg font-semibold mb-6">난이도와 만족도 상관관계</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={statData.difficultyByCount}
            ...
            <p className="text-xs text-gray-500 mt-2">난이도와 상관없이 점차 만족도가 높아지는 것으로 보입니다.</p>
            <p className="text-xs text-gray-400 mt-1">난이도가 높아질수록 플레이 경험이 향상되는 경향이 있습니다.</p>
          </div>
        </div>
      </div>
    </div>
