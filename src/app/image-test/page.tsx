...
export default function ImageTestPage() {
  // 테스트 이미지 URL
  const cafefilesImageUrl =
    "https://cafefiles.pstatic.net/MjAyNDA0MTFfMTc1/MDAxNzEyODEyODM3NDc1.QaT4BMKZyYEUF9iQXnFl2Hxg5fGW44DYNnVpvnzQWpYg.LxVoIeKGBX9UPkiIX0JxHWM3bEjTiA66JQk7Ax4GGP0g.JPEG/%BD%C3%BC%B1%C0%AF%C1%F6%C7%D5%BF%B9%BE%DF.jpg";
  const naverbookingImageUrl =
    "https://naverbooking-phinf.pstatic.net/20230905_64/1693877492148vQPjv_JPEG/KakaoTalk_Photo_2023-09-05-11-50-43_002.jpeg?type=f804_408";
  const insecureImageUrl =
    "https://www.xn--vh3bn2thtas7l8te.com/file/theme/2_a.jpg";
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <ul className="list-disc pl-5">
            <li className="mb-2">
              카페 이미지:
              <span
                className={cafeSrcError ? "text-red-500" : "text-green-500"}
              >
                {cafeSrcError ? " 실패" : " 성공"}
              </span>
            </li>
            <li className="mb-2">
              예약 이미지:
              <span
                className={bookingSrcError ? "text-red-500" : "text-green-500"}
              >
            ...
            <li className="mb-2">
              인증서 오류 이미지 (직접):
              <span
                className={insecureSrcError ? "text-red-500" : "text-green-500"}
              >
            ...
            <li>
              인증서 오류 이미지 (프록시):
              <span
                className={proxySrcError ? "text-red-500" : "text-green-500"}
              >
                {proxySrcError ? " 실패" : " 성공"}
              </span>
            </li>
        ...
        <div className="mt-8 bg-yellow-50 p-6 rounded-lg">
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              <strong>unoptimized={"{true}"} 사용</strong>: Next.js의 Image
              컴포넌트에 unoptimized 옵션을 설정하면 이미지 최적화를 건너뛰고
              직접 로드합니다.
            </li>
            <li>
              <strong>프록시 방식</strong>: Next.js의 rewrites를 사용하여 서버
              측에서 이미지를 프록시합니다. 이 방법은 브라우저가 아닌 서버에서
              이미지를 가져오므로 인증서 문제를 우회할 수 있습니다.
            </li>
            <li>
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-700">
              위 방법 중 프록시 방식이 보안 측면에서 가장 안전합니다. 사용자는
              항상 안전한 자체 도메인에서 이미지를 로드합니다.
            </p>
          </div>
        </div>
      </main>
